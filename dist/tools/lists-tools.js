export function registerListTools(client) {
    return {
        mailchimp_lists_list: {
            ...
            execute: async (params) => client.getLists(params)
        },
        mailchimp_lists_get: {
            ...
            execute: async (params) => client.getList(params.list_id)
        },
        mailchimp_lists_create: {
            ...
            execute: async (params) => client.createList(params)
        },
        ...
        mailchimp_lists_delete: {
            ...
            execute: async (params) => client.deleteList(params.list_id)
        },
        ...
        mailchimp_lists_get_segment: {
            ...
            execute: async (params) => client.getSegment(params.list_id, params.segment_id)
        },
        ...
        mailchimp_lists_delete_segment: {
            ...
            execute: async (params) => client.deleteSegment(params.list_id, params.segment_id)
        }
    };
}
//# sourceMappingURL=lists-tools.js.map
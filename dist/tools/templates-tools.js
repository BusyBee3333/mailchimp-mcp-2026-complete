export function registerTemplateTools(client) {
    return {
        mailchimp_templates_list: {
            ...
            execute: async (params) => client.getTemplates(params)
        },
        mailchimp_templates_get: {
            ...
            execute: async (params) => client.getTemplate(params.template_id)
        },
        mailchimp_templates_create: {
            ...
            execute: async (params) => client.createTemplate(params)
        },
        ...
        mailchimp_templates_delete: {
            ...
            execute: async (params) => client.deleteTemplate(params.template_id)
        },
        mailchimp_templates_get_default_content: {
            ...
            execute: async (params) => client.getTemplateDefaultContent(params.template_id)
        }
    };
}
//# sourceMappingURL=templates-tools.js.map
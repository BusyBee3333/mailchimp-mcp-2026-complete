export function registerCampaignTools(client) {
    return {
        mailchimp_campaigns_list: {
            ...
            execute: async (params) => client.getCampaigns(params)
        },
        mailchimp_campaigns_get: {
            ...
            execute: async (params) => client.getCampaign(params.campaign_id)
        },
        mailchimp_campaigns_create: {
            ...
            execute: async (params) => client.createCampaign(params)
        },
        ...
        mailchimp_campaigns_delete: {
            ...
            execute: async (params) => client.deleteCampaign(params.campaign_id)
        },
        mailchimp_campaigns_send: {
            ...
            execute: async (params) => client.sendCampaign(params.campaign_id)
        },
        ...
        mailchimp_campaigns_unschedule: {
            ...
            execute: async (params) => client.unscheduleCampaign(params.campaign_id)
        },
        mailchimp_campaigns_pause: {
            ...
            execute: async (params) => client.pauseCampaign(params.campaign_id)
        },
        mailchimp_campaigns_resume: {
            ...
            execute: async (params) => client.resumeCampaign(params.campaign_id)
        },
        mailchimp_campaigns_replicate: {
            ...
            execute: async (params) => client.replicateCampaign(params.campaign_id)
        },
        ...
        mailchimp_campaigns_get_content: {
            ...
            execute: async (params) => client.getCampaignContent(params.campaign_id)
        },
        ...
        mailchimp_campaigns_get_send_checklist: {
            ...
            execute: async (params) => client.getSendChecklist(params.campaign_id)
        }
    };
}
